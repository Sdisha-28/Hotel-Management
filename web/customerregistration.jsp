...
<html lang="en">
    ...
    <head>
        ...
        <style>
            body {
                background-image: url("gallery/sl2.jpg");
...
background-size:cover;
    ...
    <body>
        <div class="container">
            <h2 class="text-center fs-5 fw-bold  pt-5 text-white">CUSTOMER REGISTRATION FORM</h2>

            <form action="customerdb.jsp" id="cForm" class="m-5">
                ...
                <!--                <a class="btn btn- btn-outline-danger w-100 text-white" href="customerlogin.html" role="button">Create</a>-->
